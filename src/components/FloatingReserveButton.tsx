...
function FloatingReserveButton() {
  ...
  // Si el modo es WhatsApp, usar un botón que abre directamente WhatsApp
  // Si el modo es form, usar Link que lleva a /reservas
  if (isWhatsAppMode()) {
    return (
      <button
        onClick={() => window.open(getReservationUrl(), '_blank', 'noopener,noreferrer')}
